#
#  Be sure to run `pod spec lint geocore-swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Geocore"
  # s.authors            = { "Geocore" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Geocore"
  ...
  s.source       = { :git => "https://github.com/geocore/geocore-swift.git", :tag => "0.1.0" }
  ...
  s.dependency "PromiseKit/Swift/Promise", ">= 1.5"
